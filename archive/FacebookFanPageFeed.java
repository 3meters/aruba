...
import com.proxibase.aircandi.model.PostFb;
import com.proxibase.aircandi.model.PostsFb;
...
public class FacebookFanPageFeed extends AircandiActivity
{
	...
	public void loadPosts()
	{
		...
		ripple.post(method, parameters, QueryFormat.Json, Aircandi.URL_AIRCANDI_SERVICE, new PostsQueryListener());
	}
	...
	public class PostsQueryListener extends BaseQueryListener
	{
		...
		{
			mPostsFb = (PostsFb) ProxibaseService.convertJsonToObjects(response, PostsFb.class).get(0);
