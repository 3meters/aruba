...
public class Facebook
{
	 ...
	 * calling auth.expireSession through the API. Note that this method blocks waiting for a network response, so do
	 * not call it in a UI thread.
	 * 
	 * @param context
	 ...
	 * http://developers.facebook.com/docs/reference/rest/ Note that this method blocks waiting for a network response,
	 * so do not call it in a UI thread. Example: <code>
	 ...
	 * that this method blocks waiting for a network response, so do not call it in a UI thread.
	 * 
	 * @param graphPath
	 ...
	 * http://developers.facebook.com/docs/api Note that this method blocks waiting for a network response, so do not
	 ...
	 * that binary data parameters (e.g. pictures) are not yet supported by this helper function. See
	 * http://developers.facebook.com/docs/api Note that this method blocks waiting for a network response, so do not
	 * call it in a UI thread.
	 * 
	 * @param graphPath
	...
	/**
	 * Generate a UI dialog for the request action in the given Android context. Note that this method is asynchronous
	...
	/**
	 * Generate a UI dialog for the request action in the given Android context with the provided parameters. Note that
