...
public class Logger {
	...
	static private void Log(LogLevel logLevel, Object taskContext, String msgFormat, Throwable t) {
		...
		if (logLevel == LogLevel.Error) {
			Log.e(ProxiConstants.APP_NAME, task + msgFormat, t);
		}
		else if (logLevel == LogLevel.Warning) {
			Log.w(ProxiConstants.APP_NAME, task + msgFormat, t);
		}
		else if (logLevel == LogLevel.Info) {
			Log.i(ProxiConstants.APP_NAME, task + msgFormat, t);
		}
		else if (logLevel == LogLevel.Debug) {
			Log.d(ProxiConstants.APP_NAME, task + msgFormat, t);
		}
		else if (logLevel == LogLevel.Verbose) {
			Log.v(ProxiConstants.APP_NAME, task + msgFormat, t);
		}
	}
