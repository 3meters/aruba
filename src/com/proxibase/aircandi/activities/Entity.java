...
public class Entity extends AircandiActivity {
	...
	public void doSave() {
		...
		if (mBeacon != null && mBeacon.isUnregistered) {
			...
			try {
				...
				ImageUtils.showToastNotification(Entity.this, getString(R.string.post_update_failed_toast), Toast.LENGTH_SHORT);
				exception.printStackTrace();
			}
		}
	...
	private void insertEntity() {
		...
		mPostEntity.insertAsync(new IQueryListener() {
			...
			public void onComplete(String jsonResponse) {
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						ImageUtils.showToastNotification(Entity.this, getString(R.string.post_insert_success_toast), Toast.LENGTH_SHORT);
			...
			@Override
			public void onProxibaseException(ProxibaseException exception) {
				ImageUtils.showToastNotification(Entity.this, getString(R.string.post_insert_failed_toast), Toast.LENGTH_SHORT);
				mProcessing = false;
				exception.printStackTrace();
			}
		});
	...
	private void updateEntity() {
		...
		mPostEntity.updateAsync(new IQueryListener() {
			...
			public void onComplete(String response) {
				...
				Entity.this.runOnUiThread(new Runnable() {

					public void run() {
						stopTitlebarProgress();
						ImageUtils.showToastNotification(Entity.this, getString(R.string.post_update_success_toast), Toast.LENGTH_SHORT);
						Intent intent = new Intent();
	...
	public void deleteEntity() {
		...
		if (mPostEntity.imageUri != null && !mPostEntity.imageUri.equals("") && mPostEntity.imageFormat.equals("binary")) {
			...
			try {
				...
				ImageUtils.showToastNotification(Entity.this, getString(R.string.post_delete_failed_toast), Toast.LENGTH_SHORT);
				exception.printStackTrace();
			}
		}
		...
		stopTitlebarProgress();
		ImageUtils.showToastNotification(Entity.this, getString(R.string.post_delete_success_toast), Toast.LENGTH_SHORT);
		Intent intent = new Intent();
		intent.putExtra(getString(R.string.EXTRA_ENTITY_DIRTY), mPostEntity.id);
	...
	private void showImageThumbnail(Bitmap bitmap) {
		Animation animation = AnimationUtils.loadAnimation(Entity.this, R.anim.fade_in_medium);
	...
	private void showAddMediaDialog() {
		...
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(Entity.this);
