...
public class EggsMine extends AircandiActivity
{
	...
	public class ListQueryListener extends BaseQueryListener
	{
		...
		public void onIOException(IOException e)
		{
			...
			EggsMine.this.runOnUiThread(new Runnable() {
				public void run()
				{
					AircandiUI.showToastNotification(EggsMine.this, "Network error", Toast.LENGTH_SHORT);
					stopProgress();
				}
			});
	...
	public class DeleteEggListener extends BaseQueryListener
	{
		public void onComplete(final String response)
		{
			...
			EggsMine.this.runOnUiThread(new Runnable() {
				public void run()
				{
					AircandiUI.showToastNotification(EggsMine.this, "Removed from your collection", Toast.LENGTH_SHORT);
					startProgress();
