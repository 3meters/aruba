...
public class MediaList extends AircandiActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			if (jsonStream != "")
				mStream = RippleService.getGson(GsonType.Internal).fromJson(
	...
	public void onCommandClick(View view) {
		...
		parameters.putString("sourceId", getCurrentUser().id);

		rippleRunner.post(method, parameters, QueryFormat.Json, Aircandi.URL_AIRCANDI_SERVICE,
