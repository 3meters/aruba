...
public class EggsGrid extends AircandiActivity
{
	...
	public class GetEggsListener extends BaseQueryListener
	{
		...
		public void onIOException(IOException e)
		{
			...
			EggsGrid.this.runOnUiThread(new Runnable() {
				public void run()
				{
					AircandiUI.showToastNotification(EggsGrid.this, "Network error", Toast.LENGTH_SHORT);
					stopProgress();
				}
			});
		}
	...
	class GetImageTask extends AsyncTask<ImageHolder, Void, Bitmap>
	{
		...
		protected Bitmap doInBackground(ImageHolder... params)
		{
			...
			holder = params[0];
			Bitmap bitmap = AircandiUI.getImage(holder.imageUrl);
		...
		public void onComplete(final String response)
		{
			...
			EggsGrid.this.runOnUiThread(new Runnable() {
				public void run()
				{
					...
					{
						AircandiUI.showToastNotification(EggsGrid.this, "Basket Dropped!", Toast.LENGTH_SHORT);
						mEggDropRow.setVisibility(View.GONE);
						mLocManager.removeUpdates(mLocListener);
						getCurrentEntity().isDirty = true;
						startProgress();
					...
					{
						AircandiUI.showToastNotification(EggsGrid.this, "Basket was not dropped.", Toast.LENGTH_SHORT);
					}
				}
			});
		}
	...
	public class KeepEggListener extends BaseQueryListener
	{
		public void onComplete(final String response)
		{
			...
			EggsGrid.this.runOnUiThread(new Runnable() {
				public void run()
				{
					AircandiUI.showToastNotification(EggsGrid.this, "Added to your collection!", Toast.LENGTH_SHORT);
					startProgress();
					mEggDetailRow.setVisibility(View.GONE);
					loadData();
				}
