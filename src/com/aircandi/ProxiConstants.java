...
public final class ProxiConstants {
	...
	public static final String	__URL_PROXIBASE_SERVICE							= "http://ariseditions.com:8080";																												// $codepro.audit.disable constantNamingConvention //$NON-NLS-1$
	public static final String	_URL_PROXIBASE_SERVICE							= "https://api.aircandi.com";																													//$NON-NLS-1$
	public static final String	URL_PROXIBASE_SERVICE							= "https://api.aircandi.com:444";																													//$NON-NLS-1$
