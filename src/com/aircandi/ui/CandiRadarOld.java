...
public class CandiRadarOld extends CandiActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isFinishing()) {
			...
			if (!LocationManager.getInstance().isLocationAccessEnabled()) {
				...
				AnimUtils.doOverridePendingTransition(CandiRadarOld.this, TransitionType.CandiPageToForm);
				finish();
			}
					...
					public void run() {
						...
						if (location == null) {
							...
							if (mActiveLocation == null || hasMoved) {
								...
								Logger.d(CandiRadarOld.this, "Location change: updating synthetics");
				...
				runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						if (serviceResponse.responseCode == ResponseCode.Success) {
							...
							mCommon.handleServiceError(serviceResponse, ServiceOperation.BeaconScan, CandiRadarOld.this);
						}
					}
				});
			}
	...
	private void drawLayout(PlaceType placeType, ViewGroup layout, List<Entity> entities, Boolean addSparkle) {
		...
		Integer spacing = 3;
		Integer spacingHorizontalPixels = ImageUtils.getRawPixels(CandiRadarOld.this, spacing);
		Integer spacingVerticalPixels = ImageUtils.getRawPixels(CandiRadarOld.this, spacing);
		...
		for (final Entity entity : entities) {
			...
			if (viewForEntity != null) {
				...
				final CandiView candiView = new CandiView(CandiRadarOld.this);
			...
			new AsyncTask() {
				...
				protected void onPostExecute(Object response) {
					...
					if (result.serviceResponse.responseCode == ResponseCode.Success) {
						...
						mCommon.handleServiceError(result.serviceResponse, ServiceOperation.CheckUpdate, CandiRadarOld.this);
					}
				}
			}.execute();
		}
	...
	protected int getLayoutId() {
		return R.layout.candi_radar_old;
	}
