...
public class Users extends BaseApp {

	public static void view(Activity activity, String entityId) {
		IntentBuilder intentBuilder = new IntentBuilder(activity, UserForm.class).setEntityId(entityId);
	...
	public static void edit(Activity activity, Entity entity) {
		IntentBuilder intentBuilder = new IntentBuilder(activity, UserEdit.class).setEntity(entity);
	...
	public static void insert(Activity activity) {
		IntentBuilder intentBuilder = new IntentBuilder(activity, UserEdit.class).setEntitySchema(Constants.SCHEMA_ENTITY_USER);
