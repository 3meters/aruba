...
public class LocationPollingService extends Service {
	...
	private class PollingThread extends WakefulThread {
		...
		PollingThread(PowerManager.WakeLock lock, android.location.LocationManager locationManager) {
			...
			mLocationListener = new LocationListener() {
				...
				public void onLocationChanged(Location location) {
					...
					else if (location.getProvider().equals(android.location.LocationManager.GPS_PROVIDER)) {
