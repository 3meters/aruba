 ...
 * This class deserializes Gson output such that all objects are one of the following types:
 * <ul>
 * <li>String
 * <li>Boolean
 ...
 * </ul>
 * This is often useful when creating a complete new specific deserializer is too much work because just a specific
 * subset of the output is desired, or for when it isn't known exactly in advance which object maps to any given json
 * input.
 * 
...
public class GeneralObjectDeserializer implements JsonDeserializer<Object>
{
	...
	/**
	 * This is a convenience routine which deserializes a string into one of the five general Java types as described
	 * above.
	 * 
	 * @param json
	...
	/**
	 * This is a convenience routine deserializes the Json read from the specified reader into one of the five general
	 * Java types as described above.
	 * 
	 * @param json
