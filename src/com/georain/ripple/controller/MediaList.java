...
public class MediaList extends RippleActivity
{
	...
	public class ListQueryListener extends BaseQueryListener
	{
		...
		public void onIOException(IOException e)
		{
			...
			MediaList.this.runOnUiThread(new Runnable() {
				public void run()
				{
					RippleUI.showToastNotification(MediaList.this, "Network error", Toast.LENGTH_SHORT);
					stopProgress();
				}
			});
		}
	...
	public void onCommandClick(View view)
	{
		...
		RippleUI.showToastNotification(this, "Sending " + command + " command", Toast.LENGTH_SHORT);
	...
	public void onItemClick(View view)
	{
		...
		RippleUI.showToastNotification(this, "Switching to " + resource.title, Toast.LENGTH_SHORT);
		RippleRunner rippleRunner = new RippleRunner();
		rippleRunner.insert(message, "Messages", new MessageSendListener());
	}
	...
	public class MessageSendListener extends BaseModifyListener
	{
		public void onComplete()
		{
			...
			MediaList.this.runOnUiThread(new Runnable() {
				public void run()
				{
					RippleUI.showToastNotification(MediaList.this, "Sent...", Toast.LENGTH_SHORT);
					stopProgress();
				}
			});
		}
