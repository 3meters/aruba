	...
	public class QueryListener extends BaseQueryListener
	{
		public void onComplete(String response)
		{
			...
			PointEditor.this.runOnUiThread(new Runnable() {
				...
				{
					stopProgress();
					RippleUI.showToastNotification(PointEditor.this, "Saved", Toast.LENGTH_SHORT);
		...
		public void onClientProtocolException(ClientProtocolException e)
		{
			...
			PointEditor.this.runOnUiThread(new Runnable() {
				...
				{
					stopProgress();
					RippleUI.showToastNotification(PointEditor.this, "Failed to insert or modify point", Toast.LENGTH_SHORT);
				}
			});
		}
		...
		public void onIOException(IOException e)
		{
			...
			PointEditor.this.runOnUiThread(new Runnable() {
				...
				{
					stopProgress();
					RippleUI.showToastNotification(PointEditor.this, "Network error, failed to insert or modify point", Toast.LENGTH_SHORT);
				}
			});
		}
	}
