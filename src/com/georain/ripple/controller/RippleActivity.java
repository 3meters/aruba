...
//			}
	...
	private final class LogoutRequestListener extends BaseRequestListener
	{
		...
		{
			RippleActivity.this.runOnUiThread(new Runnable() {
				public void run()
				{
					...
					// Feedback
					RippleUI.showToastNotification(RippleActivity.this, "Signed out", Toast.LENGTH_SHORT);
	...
	{
		((Ripple) getApplicationContext()).currentLocation = currentLocation;
	}

	protected Location getCurrentLocation()
	{
		return ((Ripple) getApplicationContext()).currentLocation;
	}
	...
	{
		((Ripple) getApplicationContext()).currentEntityX = currentEntity;
	}
