...
public class InfoList extends RippleActivity
{
	...
	class ListQueryListener extends BaseQueryListener
	{
		...
		public void onIOException(IOException e)
		{
			...
			InfoList.this.runOnUiThread(new Runnable() {
				public void run()
				{
					RippleUI.showToastNotification(InfoList.this, "Network error", Toast.LENGTH_SHORT);
					stopProgress();
				}
			});
		}
...
//		mTileFrame.startAnimation(animation);
	...
	public void onItemClick(View view)
	{
		...
		html += "<link href='" + Ripple.URL_RIPPLEZANIA + "styles/infoitem.css' rel='stylesheet' type='text/css' />";
		html += "</head>";
		html += "<body>";
		...
		// Post post = (Post) view.getTag();
		// String jsonPost = RippleService.getGson(GsonType.Internal).toJson(post);
